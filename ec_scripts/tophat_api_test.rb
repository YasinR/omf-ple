...
msgs = {
  ...
  set_username: @comm.configure_message([username: "guest@top-hat.info"]),
  set_auth_string: @comm.configure_message([auth_string: "guest"]),
  set_api_url: @comm.configure_message([api_url: "https://api2.top-hat.info/API/"]),
